...
using PWApplication.MobileShared.Views;
using Xamarin.Forms;
...
namespace PWApplication.MobileShared.Services.NavigationService
{
    public class NavigationService : INavigationService
    {
        ...
        public async Task NavigationToBackAsync()
        {
        ...
        private async Task InternalNavigateToAsync(Type viewModelType, object parameter)
        {
            ...
            if (page.BindingContext == null) System.Diagnostics.Debug.WriteLine($"Error NavigationService not set BindingContext in {page.GetType().ToString()}");
