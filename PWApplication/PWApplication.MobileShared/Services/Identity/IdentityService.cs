...
namespace PWApplication.MobileShared.Services.Identity
{
    public class IdentityService : IIdentityService
    {
        ...
        public string CreateAuthorizationRequest()
        {
            ...
            dic.Add("scope", "openid profile email offline_access transactions");
        ...
        private string CreateCodeChallenge()
        {
            ...
            var challengeBuffer = sha256.HashData(WinRTCrypto.CryptographicBuffer.CreateFromByteArray(Encoding.UTF8.GetBytes(_codeVerifier)));
            byte[] challengeBytes;
