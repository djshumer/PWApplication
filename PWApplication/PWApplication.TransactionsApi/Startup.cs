    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger()
               .UseSwaggerUI(c =>
               {
                   c.SwaggerEndpoint($"{ (!string.IsNullOrEmpty(pathBase) ? pathBase : string.Empty) }/swagger/v1/swagger.json", "Transactions.API V1");
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddEntityFrameworkSqlServer()
                   .AddDbContext<PWTranscationContext>(options =>
                   {
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "PW Transaction HTTP API",
                    Version = "v1",
                    Description = "The PW Transaction Service HTTP API",
                ...
                options.AddSecurityDefinition("oauth2", new OAuth2Scheme
                {
                    ...
                    {
                        { "transactions", "PW Transactions API" }
                    }
                });
